    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" method="post" action="{{route('editProduct',$product->id)}}" enctype="multipart/form-data">
                    @include('messages')
                    @method('PUT')
                    {{csrf_field()}}
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="description"
                                          placeholder="Description" id="textarea2" rows="3">{{$product->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" value="{{$product->quantity}}" min="1" max="100" name="quantity">
                            </div>
                        </div>
