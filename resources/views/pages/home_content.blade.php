...
@section('content')
    ...
    <h2 class="title text-center">{{$products->links()}}</h2>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>{{$item->name}}</p>
                                            <a href="{{route('viewProduct',['id'=>$item->id,'name'=>$item->name])}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
